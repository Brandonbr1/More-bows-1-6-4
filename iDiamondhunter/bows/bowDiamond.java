...
public class bowDiamond extends ItemBow {
   ...
   public void registerIcons(IconRegister var1) {
      super.itemIcon = var1.registerIcon("mod/DiamondBow1");
   ...
   public Icon getIcon(ItemStack par1ItemStack, int renderPass, EntityPlayer player, ItemStack usingItem, int useRemaining) {
      if (player.isUsingItem() && usingItem.itemID == iDiamondhunter.bowDiamond.itemID && usingItem != null && usingItem.getItem().itemID == iDiamondhunter.bowDiamond.itemID) {
         ...
         if (var6 >= 6) {
            ...
            return var6 >= 0 ? DiamondBow1 : super.itemIcon;
         }
      } else {
