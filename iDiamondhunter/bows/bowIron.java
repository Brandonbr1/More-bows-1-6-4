...
public class bowIron extends ItemBow {
   ...
   public void registerIcons(IconRegister var1) {
      super.itemIcon = var1.registerIcon("mod/IronBow1");
   ...
   public Icon getIcon(ItemStack par1ItemStack, int par2, EntityPlayer player, ItemStack var4, int var5) {
      if (player.isUsingItem() && var4.itemID == iDiamondhunter.bowIron.itemID && var4 != null && var4.getItem().itemID == iDiamondhunter.bowIron.itemID) {
