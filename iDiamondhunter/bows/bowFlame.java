...
public class bowFlame extends ItemBow {
   ...
   public void registerIcons(IconRegister var1) {
      super.itemIcon = var1.registerIcon("mod/FlameBow1");
   ...
   public Icon getIcon(ItemStack par1ItemStack, int par2, EntityPlayer player, ItemStack usingItem, int useRemaining) {
      if (player.isUsingItem() && usingItem.itemID == iDiamondhunter.bowFlame.itemID && usingItem != null && usingItem.getItem().itemID == iDiamondhunter.bowFlame.itemID) {
