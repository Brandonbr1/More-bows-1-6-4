...
public class bowMulti extends ItemBow {
   ...
   public void registerIcons(IconRegister var1) {
      super.itemIcon = var1.registerIcon("mod/MultiBow1");
   ...
   public Icon getIcon(ItemStack par1ItemStack, int par2, EntityPlayer player, ItemStack usingItem, int useRemaining) {
      if (player.isUsingItem() && usingItem.itemID == iDiamondhunter.bowMulti.itemID && usingItem != null && usingItem.getItem().itemID == iDiamondhunter.bowMulti.itemID) {
      ...
      if (!event.isCanceled()) {
         ...
         if (flag || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID)) {
            ...
            if (!par2World.isRemote) {
               ...
               if (par3EntityPlayer.rotationYaw > 180.0F) {
                  var9.posX += (double)(par3EntityPlayer.rotationYaw / 180.0F);
               } else {
                  var9.posX += (double)(par3EntityPlayer.rotationYaw / 180.0F);
               }
               ...
               if (this.rand.nextInt(4) == 0) {
                  ...
                  if (par3EntityPlayer.rotationYaw > 180.0F) {
                     var10.posX -= (double)(par3EntityPlayer.rotationYaw / 180.0F);
                  } else {
                     var10.posX -= (double)(par3EntityPlayer.rotationYaw / 180.0F);
                  }
               }
